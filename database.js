...
app.post("/students", async (req, res) => {
    ...
    res.status(201).send(`<h1 style='color:green;'>you have success filed your information with affectedRow= ${rows[0].affectedRows}</h1>`)
})
...
//อย่าลืมเปิด xampp ก่อน
//npm init
//npm i express body-parser mysql2 nodemon
